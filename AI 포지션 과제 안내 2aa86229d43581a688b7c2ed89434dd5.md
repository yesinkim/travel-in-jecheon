...
- [x]  Hugging Face Dataset 링크 (RAG 학습/평가 데이터셋)
    - https://huggingface.co/datasets/bailando/travel-in-jecheon
- [x]  Hugging Face Model 링크 (Fine-tuned 모델)
    - https://huggingface.co/bailando/kanana-jecheon
- [x]  구현 코드 (GitHub 링크)
    - https://github.com/yesinkim/travel-in-jecheon
- [x]  결과 보고서 (PDF 또는 Markdown)
    - [ ]  데이터 구축에 대한 설명
...
- [모델 파인튜닝 방법](https://arxiv.org/pdf/2505.10792) 참고
- 하이퍼파라미터 설정 및 근거
- 학습 과정 및 Loss 그래프
- 직면한 문제와 해결 방법
